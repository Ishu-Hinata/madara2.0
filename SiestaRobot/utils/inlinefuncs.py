...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/d83dfe2c99476457cede5.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Uchiha_Madara_Robot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Madara Robot](https://t.me/AnimeGroup_Chats):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/Lord_DSP_3)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/932da959061e3265d68eb.jpg",
            input_message_content=InputTextMessageContent(
